...
public class SandboxListas
{
    ...
    public List<Integer> getCopiaEnteros( )
    {
    	...
    	{
    		copiaEnteros.add(listaEnteros.get(i));
    	}
    ...
    public List<String> getCopiaCadenas( )
    {
    	...
    	{
    		copiaCadenas.add(listaCadenas.get(i));
    	}
    ...
    {
    	if ( posicion <= listaEnteros.size()-1
    			&& posicion > -1) {
    ...
    public void reiniciarArregloEnteros( double[] valores )
    {
        ...
        for (Double num : valores) {
        	rounded.add((int) Math.round(num));
        }
        
        listaEnteros = rounded;
    }
    ...
    {
    	int count = Collections.frequency(listaEnteros, valor);
        return count;
    }
    ...
    public boolean compararArregloEnteros( int[] otroArreglo )
    {
        ...
        while (iterator.hasNext()) {
            ...
            if (!elemento.equals(otroArreglo[i])) {
                return false; 
            }
            i++;
        }
