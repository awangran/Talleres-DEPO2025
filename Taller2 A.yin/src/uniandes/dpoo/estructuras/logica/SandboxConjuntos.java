...
public class SandboxConjuntos
{
    ...
    {
    	List<String> listaCadenas = new ArrayList<String>(arbolCadenas);
        return listaCadenas;
    }
    ...
    public List<String> getCadenasComoListaInvertida( )
    {
        ...
        List<String> listaCadenas = new ArrayList<String>(reverso);
        return listaCadenas;
    }
    ...
    {
    	NavigableSet<String> arbolUpper = new TreeSet<String>( );
    	
    	Iterator<String> it = arbolCadenas.iterator();
        while (it.hasNext()) {
            String cadena = it.next();
            arbolUpper.add(cadena.toUpperCase());
        }

        arbolCadenas = arbolUpper;
    }
    ...
    {
    	NavigableSet<String> descendiente = arbolCadenas.descendingSet();
    	return (TreeSet<String>) descendiente;
    }
    ...
    public boolean compararElementos(String[] otroArreglo) {
        boolean contieneTodos = arbolCadenas.containsAll(Arrays.asList(otroArreglo));
